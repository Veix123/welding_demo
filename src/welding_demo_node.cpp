...
int main(int argc, char** argv)
{
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools(welding_demo_node, "base_link", "welding_demo_tutorial",
  ...
  while (1)
  {
    visual_tools.prompt("Press 'next' in the RvizVisualToolsGui window to create a plan for a test trajectory");
    ...
    RCLCPP_INFO(LOGGER, "Visualizing plan for a Cartesian path (%.2f%% achieved)", fraction * 100.0);
